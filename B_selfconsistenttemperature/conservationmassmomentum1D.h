...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MASS CONSERVATION    :  ∇.(nv) - Sp = 0
Normalization factor :  n_o * c_st
Normalized PDE       :  ∇.(NM) - Spn = 0 -> (N∇M + M∇N) - Spn = 0
--------------------------------------------------------------*/
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MOMENTUM CONSERVATION :  ∇(mnv² + 2nT) = -mv*Scx -> ∇(mnv² + 2nT) + mv*Scx = 0
Normalization factor  :  n_o * c_st²
...
plasma_flow += integral(SOL, dof(M)*Scxn  * tf(M));     // 4th term: zero for 2point model
...
//-----------------------------------------------------------------------------------------
// B) RESIDUALS (R)
// works better for Scx=0, but not for Scx!=0: Use this for 2-point model Validation
